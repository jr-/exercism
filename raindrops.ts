...
leaving no remainder. The simplest way to test if one number is a factor of another 
is to use the modulo operation.
...
export function convert(num: number) {
    ...
    return rainDropString ? rainDropString : `${num}`
}
